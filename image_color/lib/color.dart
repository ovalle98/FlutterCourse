...
class _ColorPickerWidgetState extends State<ColorPickerWidget> {
  String imagePath = 'assets/santorini.jpg';
  ...
  void _calculatePixel(Offset globalPosition) {
    ...
    print('Red hex = ${Color(hex).red}  pixel = ${Color(hex).red}');
    print('Green hex = ${Color(hex).green}  pixel = ${Color(hex).green}');
    print('Blue hex = ${Color(hex).blue}  pixel = ${Color(hex).blue}');
